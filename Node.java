...
public class Node implements java.io.Serializable {
	...
	public ArrayList<Node> popParentFromNeighbors(Node object) {
		...
		for (int i = 0; i < this.getNeighborsCnt(); i++) {
			// System.out.println("-----nei host name-----" +
			// this.neighbors.get(i).getHostName());

			if (object.getHostName().intern() == this.neighbors.get(i).getHostName().intern()) { // Why can not compare
																									// port number?
